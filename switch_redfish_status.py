#!/usr/bin/env python3
"""
GB300 Switch Redfish Task Status Script
Queries Redfish TaskService to check task progress for switch systems.
Reads from switch_bmc.yaml and displays PercentComplete for each system.
"""
...
def log_session_start():
    ...
    logging.info(f"Script: switch_redfish_status.py")
...
def main():
    ...
    print("GB300 Switch Redfish Task Status Checker")
    print("=" * 44)
    
    try:
        # Load and parse switch_bmc.yaml file
        print("Loading switch_bmc.yaml...")
